ALTER TYPE "estado_reporte" ADD VALUE 'VOLVER_A_REPORTAR';
--> statement-breakpoint
ALTER TABLE "reportes" ADD COLUMN "motivo_rechazo" text;
--> statement-breakpoint
ALTER TABLE "reportes" ADD COLUMN "audio_rechazo_url" varchar(500);
--> statement-breakpoint
CREATE TYPE "public"."tipo_duracion_suspension" AS ENUM('TIEMPO', 'DIAS');
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "suspensiones_usuarios" ADD CONSTRAINT "suspensiones_usuarios_usuario_id_usuarios_id_fk" FOREIGN KEY ("usuario_id") REFERENCES "public"."usuarios"("id") ON DELETE no action ON UPDATE no action;
--> statement-breakpoint
