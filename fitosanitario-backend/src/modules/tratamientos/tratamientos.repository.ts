...
export class TratamientosRepository {
  ...
  async findAll() {
    return this.db
      ...
      .innerJoin(schema.cultivos,                eq(schema.tratamientosOficiales.cultivoId,  schema.cultivos.id))
      .innerJoin(schema.plagasEnfermedades,       eq(schema.tratamientosOficiales.plagaId,    schema.plagasEnfermedades.id))
      .innerJoin(schema.productosFitosanitarios,  eq(schema.tratamientosOficiales.productoId, schema.productosFitosanitarios.id))
      .innerJoin(schema.usuarios,                eq(schema.tratamientosOficiales.moderadorId, schema.usuarios.id))
  ...
  async findEnciclopedia() {
    return this.db
      ...
      .orderBy(
        schema.cultivos.nombre,
        schema.plagasEnfermedades.nombre,
      );
  }
